  ...
  return (
    <div className='bg-black text-white text-center py-16'>
        ...
        <h1 className='text-4x1 font-bold'>
            I'm {" "}
            <span className='text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500'>Frantz-Sebastien Mathias</span>
            ,Full-Stack Developer
        </h1>
        <p className='mt-4 text-lg text-gray-300'>
            I specialized in building website. I'll add more here
        </p>
        <div className='mt-8 space-x-4'>
            ...
            >Contact with Me</button> {/*Connect With Me*/}
            <button
